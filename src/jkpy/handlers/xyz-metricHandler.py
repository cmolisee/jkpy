...
#                 is_na = dataset["fields.customfield_10264.displayName"].isna()
#                 is_empty = (dataset["fields.customfield_10264.displayName"] == '')
#                 matches_value = (dataset["fields.customfield_10264.displayName"] == displayName)
                
#                 primaryDevDf=dataset[is_na|is_empty|matches_value]
